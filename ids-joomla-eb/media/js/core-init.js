            ...
            _setKeyup() {
              this.component.addEventListener('keyup', () => {
                ...
                if (characterCount <= this.maximum && !this.characters) {
                  ...
                  this.currentValue.innerHTML = `Restam <strong>${this.maximum - characterCount
                    }</strong> caracteres`
                }
            ...
            _fixPosition() {
              if (this.notification) {
                setTimeout(() => {
                  ...
                  this.component.style = `position: fixed !important; top: ${ac.top + ac.height + 10
                    }px !important; left: auto; right: 8px; display: unset; bottom: auto;`
                  this.component.querySelector(
                    '.arrow'
                  ).style = `position: absolute; left: auto; right: ${document.body.clientWidth - ac.right + ac.width / 5
                    }px !important;`
                }, 10)
              }
            }
